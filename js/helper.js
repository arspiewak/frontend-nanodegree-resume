...
*/
var HTMLheaderName = '<div class="header-flex-box"><h1 id="name">%data%</h1>';
var HTMLheaderRole = '<span class="orange-text">%data%</span>';
// Add a logo for fun
var HTMLudacityLogo = '<img class="udacity-logo" src="images/udacity-logo.svg" alt="Udacity logo"></div><hr>';
...
var HTMLbioPic = '<img src="%data%" class="biopic" alt="Thumbnail photo of my face">';
...
var HTMLprojectTitle = '<a href="#" class="project-link">%data%</a>';
var HTMLprojectDates = '<p class="date-text">%data%</p>';
var HTMLprojectDescription = '<p><br>%data%</p>';
var HTMLprojectImage = '<img src="%data%" alt="Project thumbnail photo">';
...
function initializeMap() {
  ...
  */
  function createMapMarker(placeData) {
    ...
    // Format what infoWindow will display
    var fmtName = '<div class="info-window">Location<br>' + name + '</div>';
